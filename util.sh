...
video_capture_external.o|device_info_external.o"
  ...
  local extras=$(find \
    ...
    ./obj/third_party/openh264/openh264_common_yasm \
    ./obj/third_party/openh264/openh264_encoder_yasm \
    ./obj/third_party/openh264/openh264_processing_yasm -name '*\.o')
...
function compile() {
  ...
  local common_args="is_component_build=false rtc_include_tests=false rtc_use_h264=true treat_warnings_as_errors=false"
